...
import firrtl2.annotations.{CircuitTarget, PresetAnnotation}
import firrtl2.options.Dependency
import firrtl2.testutils.LeanTransformSpec

class FirrtlToTransitionSystemPassSpec
    extends LeanTransformSpec(Seq(Dependency(firrtl2.backends.experimental.smt.FirrtlToTransitionSystem))) {
