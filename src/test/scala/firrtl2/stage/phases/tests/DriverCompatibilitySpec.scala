...
import firrtl2._
import firrtl2.stage.phases.DriverCompatibility._
import firrtl2.options.{InputAnnotationFileAnnotation, Phase, TargetDirAnnotation}
...
import firrtl2.stage.phases.DriverCompatibility
