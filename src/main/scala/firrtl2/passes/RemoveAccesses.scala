...
import firrtl2.{Namespace, Transform, WRef, WSubAccess, WSubField, WSubIndex}
import firrtl2.PrimOps.{And, Eq}
import firrtl2.ir._
...
/** Removes all [[firrtl2.WSubAccess]] from circuit
  */
object RemoveAccesses extends Pass {
  ...
  /** Returns true if e contains a [[firrtl2.WSubAccess]]
    */
  ...
  private def create_exps(e: Expression) =
    createExpsCache.getOrElseUpdate(e, firrtl2.Utils.create_exps(e))
