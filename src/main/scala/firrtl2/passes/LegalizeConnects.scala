...
import firrtl2.{bitWidth, Transform}
...
object LegalizeConnects extends Pass {
  ...
  override def prerequisites = firrtl2.stage.Forms.MidForm :+ Dependency(LowerTypes)
...
/** Ensure that all connects have the same bit-width on the RHS and the LHS.
  */
private[firrtl2] object LegalizeConnectsOnly extends Pass {
