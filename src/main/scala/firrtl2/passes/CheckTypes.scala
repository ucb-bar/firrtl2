...
import firrtl2.WrappedType._
import firrtl2.constraint.{Constraint, IsKnown}
import firrtl2.options.Dependency

object CheckTypes extends Pass {

  override def prerequisites = Dependency(InferTypes) +: firrtl2.stage.Forms.MinimalHighForm
