...
import firrtl2.annotations.{CircuitTarget, ModuleTarget, Target, TargetToken}
import firrtl2.options.Dependency

object CheckWidths extends Pass {

  override def prerequisites = Dependency[passes.InferWidths] +: firrtl2.stage.Forms.MinimalHighForm
