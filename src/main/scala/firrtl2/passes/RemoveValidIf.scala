...
/** Remove [[firrtl2.ir.ValidIf ValidIf]] and replace [[firrtl2.ir.IsInvalid IsInvalid]] with a connection to zero */
object RemoveValidIf extends Pass {
  ...
  /** Returns an [[firrtl2.ir.Expression Expression]] equal to zero for a given [[firrtl2.ir.GroundType GroundType]]
    *
    * @note Accepts [[firrtl2.ir.Type Type]] but dyanmically expects [[firrtl2.ir.GroundType GroundType]]
    */
  ...
  override def invalidates(a: Transform): Boolean = a match {
    case _: firrtl2.transforms.ConstantPropagation => true // switching out the validifs allows for more constant prop
    case _ => false
  }
