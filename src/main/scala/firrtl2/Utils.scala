...
object Utils extends LazyLogging {
  ...
  /** Removes all [[firrtl2.ir.EmptyStmt]] statements and condenses
    * [[firrtl2.ir.Block]] statements.
    */
  ...
  /** Returns true if t, or any subtype, contains a flipped field
    *
    * @param t type [[firrtl2.ir.Type]] to be checked
    * @return if t contains [[firrtl2.ir.Flip]]
    */
...
// =========== ACCESSORS =========
  ...
  /** Splits an Expression into root Ref and tail
    ...
    *   b[2].c -> (b, EMPTY[2].c)
    * @note This function only supports [[firrtl2.ir.RefLikeExpression RefLikeExpression]]s: [[firrtl2.ir.Reference
    * Reference]], [[firrtl2.ir.SubField SubField]], [[firrtl2.ir.SubIndex SubIndex]], and [[firrtl2.ir.SubAccess
    * SubAccess]]
    */
  ...
  /** Gets the root declaration of an expression
    *
    * @param m    the [[firrtl2.ir.Module]] to search
    * @param expr the [[firrtl2.ir.Expression]] that refers to some declaration
    * @return the [[firrtl2.ir.IsDeclaration]] of `expr`
  ...
  private[firrtl2] def collectInstantiatedModules(mod: Module, map: Map[String, DefModule]): Seq[DefModule] = {
