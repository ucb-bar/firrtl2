...
trait Annotation extends Product {
  ...
  /** Returns all [[firrtl2.annotations.Target Target]] members in this annotation
    *
    * @return
    */
  ...
  /** Returns a deduplicable representation of this [[Annotation]]: a 3-tuple of the
    ...
    * [[firrtl2.annotations.ReferenceTarget ReferenceTarget]](s) to the annotated objects.
    *
    ...
    * @return
    */
  private[firrtl2] def dedup: Option[(Any, Annotation, ReferenceTarget)] = None
}
...
trait MultiTargetAnnotation extends Annotation {
  ...
  /** Contains a nested sequence of [[firrtl2.annotations.Target Target]]
    *
