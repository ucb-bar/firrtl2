...
import firrtl2.{AnnotationSeq, ChirrtlForm, CircuitState, Compiler => FirrtlCompiler, Transform, seqToAnnoSeq}
...
class Compiler extends Phase with Translator[AnnotationSeq, Seq[CompilerRun]] {
  ...
  private def compilerToTransforms(a: FirrtlCompiler): Seq[TransformDependency] = a match {
    case _: firrtl2.NoneCompiler         => Forms.ChirrtlForm
    case _: firrtl2.HighFirrtlCompiler   => Forms.MinimalHighForm
    case _: firrtl2.MiddleFirrtlCompiler => Forms.MidForm
    case _: firrtl2.LowFirrtlCompiler    => Forms.LowForm
    case _: firrtl2.VerilogCompiler | _: firrtl2.SystemVerilogCompiler => Forms.LowFormOptimized
    case _: firrtl2.MinimumVerilogCompiler => Forms.LowFormMinimumOptimized
  }
