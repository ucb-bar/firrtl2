...
import firrtl2.{AnnotationSeq, Transform}
...
/** Contains information about a [[Shell]] command line option
  ...
  * @param toAnnotationSeq a function to convert the type into an [[firrtl2.AnnotationSeq AnnotationSeq]]
...
/** A [[Transform]] that includes an option that should be exposed at the top level.
  ...
  * src/main/resources/META-INF/services/firrtl2.options.RegisteredTransform
  */
...
/** A class that includes options that should be exposed as a group at the top level.
  *
  * @note To complete registration, include an entry in
  * src/main/resources/META-INF/services/firrtl2.options.RegisteredLibrary
  */
