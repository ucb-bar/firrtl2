...
import firrtl2.annotations.TargetToken.{Field, Index, Instance, OfModule}
import TargetUtils.{instKeyPathToTarget, unfoldInstanceTargets}
import firrtl2.renamemap._
...
object RenameMap {
  ...
  /** RenameMap factory for simple renaming of instances
    ...
    */
  private[firrtl2] def fromInstanceRenames(
...
sealed trait RenameMap {
  ...
  /** Record that the from [[firrtl2.annotations.CircuitTarget CircuitTarget]] is renamed to another
    * [[firrtl2.annotations.CircuitTarget CircuitTarget]]
    *
    * @param from
    * @param to
    * $noteSelfRename
  ...
  /** Record that the from [[firrtl2.annotations.CircuitTarget CircuitTarget]] is renamed to another sequence of
    * [[firrtl2.annotations.CircuitTarget CircuitTarget]]s
    *
    * @param from
    * @param tos
    * $noteSelfRename
  ...
  /** Record that the from [[firrtl2.annotations.IsMember Member]] is renamed to another [[firrtl2.annotations.IsMember
    * IsMember]]
    *
    * @param from
    * @param to
  ...
  /** Record that the from [[firrtl2.annotations.IsMember IsMember]] is renamed to another sequence of
    * [[firrtl2.annotations.IsMember IsMember]]s
    *
    * @param from
    * @param tos
    * $noteSelfRename
  ...
  /** Records that the keys in map are also renamed to their corresponding value seqs. Only
    * ([[firrtl2.annotations.CircuitTarget CircuitTarget]] -> Seq[ [[firrtl2.annotations.CircuitTarget CircuitTarget]] ])
    * and ([[firrtl2.annotations.IsMember IsMember]] -> Seq[ [[firrtl2.annotations.IsMember IsMember]] ]) key/value
    * allowed
    *
    * @param map
    * $noteSelfRename
  ...
  /** Records that a [[firrtl2.annotations.CompleteTarget CompleteTarget]] is deleted
    *
    * @param name
    */
  @deprecated("Use firrtl.renamemap.MutableRenameMap for recording renames", "FIRRTL 1.5")
  ...
  /** Renames a [[firrtl2.annotations.CompleteTarget CompleteTarget]]
    *
  ...
  /** Get renames of a [[firrtl2.annotations.CircuitTarget CircuitTarget]]
    *
  ...
  /** Get renames of a [[firrtl2.annotations.IsMember IsMember]]
    *
  ...
  /** Get renames of a [[firrtl2.annotations.CompleteTarget CompleteTarget]]
    *
    * @param key Target referencing the original circuit
    * @return Optionally return sequence of targets that key remaps to
    */
...
package object renamemap {
  object MutableRenameMap {
    ...
    // (eg. LowerTypes). The onus is on the user of this API to be very careful and not inject
    // duplicates. This is a bad, hacky API that no one should use
    private[firrtl2] def noDistinct(): MutableRenameMap = new MutableRenameMap(doDistinct = false)
  }

  // Override deprecated methods so they aren't deprecated when using this class
  final class MutableRenameMap private[firrtl2] (
