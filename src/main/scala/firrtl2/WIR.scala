...
import firrtl2.passes.CheckTypes.legalResetType
...
/** Internal class used for propagating [[Info]] across [[Expression]]s
  ...
  */
private[firrtl2] case class InfoExpr(info: Info, expr: Expression) extends Expression {
...
private[firrtl2] object InfoExpr {
...
private[firrtl2] sealed trait HasMapWidth {
