...
package firrtl2.parser

import firrtl2.antlr._
import firrtl2.Visitor
import firrtl2.Parser.InfoMode
import firrtl2.ir._
import firrtl2.UnsupportedVersionException

import scala.collection.mutable
import scala.concurrent.{Await, Future}
import scala.concurrent.duration.Duration

private[firrtl2] class Listener(infoMode: InfoMode) extends FIRRTLBaseListener {
