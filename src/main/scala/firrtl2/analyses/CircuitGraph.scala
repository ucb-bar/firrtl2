...
import firrtl2.ir.{Circuit, DefInstance}
...
object CircuitGraph {
  ...
  /** Build a CircuitGraph
    * [[firrtl2.ir.Circuit]] must be of MiddleForm or lower
    *
    * @param circuit
    * @return
    */
  ...
  /** Return a nicely-formatted string of a path of [[firrtl2.annotations.ReferenceTarget]]
    *
