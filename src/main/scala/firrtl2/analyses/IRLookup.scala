...
class IRLookup private[analyses] (
  ...
  /** get expression of the target.
    ...
    *  - component is wrong
    *
    * @param t    [[firrtl2.annotations.ReferenceTarget]] to be queried.
  ...
  /** Find [[firrtl2.annotations.ReferenceTarget]] with a specific [[firrtl2.Kind]] in a [[firrtl2.annotations.ModuleTarget]]
    *
    * @param moduleTarget [[firrtl2.annotations.ModuleTarget]] to be queried.
    * @param kind         [[firrtl2.Kind]] to be find.
    * @return all [[firrtl2.annotations.ReferenceTarget]] in this node.
    */
  ...
  /** Returns the references to the module's ports
    *
    * @param mt [[firrtl2.annotations.ModuleTarget]] to be queried.
  ...
  /** Given:
    * A [[firrtl2.annotations.ReferenceTarget]] of ~Top|Module>ref, which is a type of {foo: {bar: UInt}}
    * Return:
  ...
  /** Given:
    * A [[firrtl2.annotations.ReferenceTarget]] of ~Top|Module>ref and a type of {foo: {bar: UInt}}
    * Return:
  ...
  /** @param mt [[firrtl2.annotations.ModuleTarget]] or [[firrtl2.annotations.InstanceTarget]] to be queried.
  ...
  /** @param t [[firrtl2.annotations.ReferenceTarget]] to be queried.
    * @return whether a given [[firrtl2.annotations.IsModule]] is valid, given the circuit's module/instance hierarchy
    */
