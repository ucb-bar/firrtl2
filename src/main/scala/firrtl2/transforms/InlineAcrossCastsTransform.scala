...
import firrtl2.Utils.{isBitExtract, isCast, NodeMap}
...
object InlineAcrossCastsTransform {
  ...
  /** Inline across casts in a statement
    ...
    *                [[firrtl2.ir.Expression Expression]]s. This function '''will''' mutate
    *                it if stmt is a [[firrtl2.ir.DefNode DefNode]]
    *                with a value that is a cast [[firrtl2.ir.PrimOp PrimpOp]]
