...
import firrtl2.Utils.{throwInternalError, toTarget}
import firrtl2.options.Dependency
import firrtl2.passes.{InferTypes, Pass, PassException}
...
/** Infers the concrete type of [[firrtl2.ir.ResetType ResetType]]s by their connections
  *
  * There are 3 cases
  ...
  *
  * @note This is a global inference because ports can be of type [[firrtl2.ir.ResetType ResetType]]
