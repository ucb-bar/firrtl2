...
import firrtl2._
import firrtl2.ir._
import firrtl2.passes.{ExpandConnects, InferTypes, LowerTypes, ResolveFlows, ResolveKinds}
...
class TopWiringTransform extends Transform {
  ...
  private def getSourcesMap(state: CircuitState): Map[String, Seq[(ComponentName, Type, Boolean, InstPath, String)]] = {
    ...
    val instGraph = firrtl2.analyses.InstanceKeyGraph(state.circuit)
  ...
  private def onModule(
    ...
    instgraph:    firrtl2.analyses.InstanceKeyGraph,
