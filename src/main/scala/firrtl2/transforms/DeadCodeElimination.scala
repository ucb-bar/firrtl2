...
import firrtl2.Utils.{kind, throwInternalError}
import firrtl2.MemoizedHash._
...
/** Dead Code Elimination (DCE)
  ...
  *
  * This transform preserves deduplication. All instances of a given [[firrtl2.ir.DefModule]] are treated as
