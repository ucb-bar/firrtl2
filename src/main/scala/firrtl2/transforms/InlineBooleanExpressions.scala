...
import firrtl2.annotations.{NoTargetAnnotation, Target}
import firrtl2.annotations.TargetToken.{fromStringToTargetToken, OfModule, Ref}
import firrtl2.ir._
import firrtl2.passes.{InferTypes, LowerTypes, SplitExpressions}
...
/** Inline Bool expressions
  ...
  * 2. is bound to a [[firrtl2.ir.DefNode DefNode]] with name starting with '_'
  * 3. is bound to a [[firrtl2.ir.DefNode DefNode]] with a source locator that
