...
object ReplaceTruncatingArithmetic {
  ...
  /** Replaces truncating arithmetic in an Expression
    ...
    *                [[firrtl2.ir.Expression Expression]]s. It is '''not''' mutated in this function
  ...
  /** Replaces truncating arithmetic in a Statement
    *
    * @param netlist a '''mutable''' HashMap mapping references to [[firrtl2.ir.DefNode DefNode]]s to their connected
    *                [[firrtl2.ir.Expression Expression]]s. This function '''will''' mutate it if stmt contains a [[firrtl2.ir.DefNode
    * DefNode]]
